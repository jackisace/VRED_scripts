...
call_bind:                    #
    ...
    push  eax;                        # size or sockaddr = 16 bytes
    push  edi;                        # pointer to sockaddr_in struct
    push  esi;                        # s = socket descriptor
    call dword ptr [ebp+0x24];        # Call bind(ListenSocket, (SOCKADDR *) &service, sizeof (service));
